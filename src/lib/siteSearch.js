const ROUTES = [
  ...
  ['AutoCAM', '/autocam', 'Manufacturing', 'cam toolpaths machining'],
  ['Fusion AutoCAM', '/autocam/fusion', 'Manufacturing', 'fusion cam add-in'],
  ...
  ['Planner', '/planner', 'Planning', 'schedule gantt timeline'],
  ['Tasks', '/tasks', 'Planning', 'todo work assignments'],
