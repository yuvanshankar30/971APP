<script>
  ...
  import { defaultHeaderTabs, ensureDataScoutTab, ensurePowerRankingsTab, ensureScoutingAdminTab, ensureStrategyTab } from '$lib/defaultTabs.js';
  ...
  $: baseNavTabs = addAdminTabIfAllowed(ensureScoutingAdminTab(ensureDataScoutTab(ensureStrategyTab(ensurePowerRankingsTab(effectiveTabs, navConfig)))), canViewAdmin);
