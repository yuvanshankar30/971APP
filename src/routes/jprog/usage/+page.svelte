...
<svelte:head><title>JProg Usage Guide | Spartans Hub</title></svelte:head>

<div class="page-header">
  <h1><HelpCircle size={28} /> Using JProg</h1>
  <a class="btn btn-secondary btn-sm" href="/jprog"><ArrowLeft size={14} /> Back to JProg</a>
</div>
