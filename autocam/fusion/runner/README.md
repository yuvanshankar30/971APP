...
- **Safe manual tabs** — places uniform `0.6in` wide tabs at explicit midpoint SketchPoints on straight, stock-backed outer release edges; height is capped at `0.15in` or 70% of the thinnest nested stock
